          ...
          <TabPane tabId="1">
            <div>
              <Row className="icon-list">
                ...
                <Col md={4} lg={3} xs={12} className="list-item"><a href="https://rsv.ru/portal/edu/courses/1/334?mView=detail" target="blank">Уроки лидерства</a></Col>
                <Col md={4} lg={3} xs={12} className="list-item"><a href="https://rsv.ru/portal/edu/courses/1/334" target="blank">Пройти тестирование</a></Col>
